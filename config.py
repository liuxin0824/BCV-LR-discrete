...
def _apply_runtime_vals(cfg: Config) -> None:
    ...
    #cfg.online_ft.batch_size = int(cfg.online_ft.num_envs * cfg.online_ft.num_steps)
    #cfg.online_ft.minibatch_size = int(cfg.online_ft.batch_size // cfg.online_ft.num_minibatches)
